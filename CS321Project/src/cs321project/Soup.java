...
/**
 ...
 CS 321-03
 November 28, 2021
 The class for the Soup food type, implementing functions from
...
public class Soup implements Food {
    ...
    */       
    ...
    private final int type = 2; // Type 2 corresponds to soup
    private int size = 0; // Default size is 0 (small); can also be 1 (large)
    private final String name = "Soup"; // The name of the food; used for printing the cart/ticket
