...
public class MacNCheese implements Food {
    ...
    */     
    ...
    private final int type = 3; // Type 3 corresponds to mac'n'cheese
    private int size = 0; // Default size is 0 (small); can also be 1 (large)
    private final String name = "Mac'n'Cheese"; // The name of the food; used for printing the cart/ticket
